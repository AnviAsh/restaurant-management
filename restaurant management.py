...
# Create labels and entry widgets for each menu item
        ...
        for i,(item,price) in enumerate(self.menu_items.items(),start = 1):
            label = ttk.Label(frame , text = f"{Item}(${price}):" , font = ("Arial") )
        ...
        ttk.Label(frame , text = "currency" , font = ("Arial" , 12)).grid(row = len(self.menu_items)+1 , coloumn = 0 , padx = 10 , pady= 5)
        ...
        order_button = ttk.Button(frame , text = "Place Order Or die" , command = self.place_order)
